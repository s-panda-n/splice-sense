...
# LoRA — 500M is too large to fully fine-tune
...
print("Model loaded with LoRA OK")
...
args = TrainingArguments(
    output_dir="models/checkpoints/nt-500m-splice",
    num_train_epochs=3,
...
trainer.train()
model.save_pretrained("models/checkpoints/nt-500m-splice")
tokenizer.save_pretrained("models/checkpoints/nt-500m-splice")
print("Done — saved to models/checkpoints/nt-500m-splice")
